...
char *url_escape(CURL *curl, const char *str){
    /*
...
char *combine(char **out, const char *f, const char *s, const char *sep){
    /*
...
pouch_request *pr_add_header(pouch_request *pr, const char *h){
    /*
...
pouch_request *pr_set_method(pouch_request *pr, const char *method){
    /*
...
pouch_request *pr_set_url(pouch_request *pr, const char *url){
    /*
...
pouch_request *pr_set_data(pouch_request *pr, const char *str){
    /*
...
pouch_request *pr_add_param(pouch_request *pr, const char *key, const char *value){
    /*
...
pouch_request *get_all_dbs(pouch_request *p_req, const char *server){
    /*
...
pouch_request *db_delete(pouch_request *p_req, const char *server, const char *db){
    /*
...
pouch_request *db_create(pouch_request *p_req, const char *server, const char *db){
    /*
...
pouch_request *db_get(pouch_request *p_req, const char *server, const char *db){
    /*
...
pouch_request *db_get_changes(pouch_request *pr, const char *server, const char *db){
    /*
...
pouch_request *db_get_revs_limit(pouch_request *pr, const char *server, const char *db){
    /*
...
pouch_request *db_set_revs_limit(pouch_request *pr, const char *server, const char *db, const char *revs){
    /*
...
pouch_request *db_compact(pouch_request *pr, const char *server, const char *db){
    /*
...
pouch_request * doc_get(pouch_request *pr, const char *server, const char *db, const char *id){
    /*
...
pouch_request *doc_get_rev(pouch_request *pr, const char *server, const char *db, const char *id, const char *rev){
    /*
...
pouch_request *doc_get_revs(pouch_request *pr, const char *server, const char *db, const char *id){
    /*
...
pouch_request *doc_get_info(pouch_request *pr, const char *server, const char *db, const char *id){
    /*
...
pouch_request *doc_create_id(pouch_request *pr, const char *server, const char *db, const char *id, const char *data){
    /*
...
pouch_request *doc_create(pouch_request *pr, const char *server, const char *db, const char *data){
    /*
...
pouch_request *get_all_docs(pouch_request *pr, const char *server, const char *db){
    /*
...
pouch_request *get_all_docs_by_seq(pouch_request *pr, const char *server, const char *db){
    /*
...
pouch_request *doc_get_attachment(pouch_request *pr, const char *server, const char *db, const char *id, const char *name){
    /*
...
pouch_request *doc_copy(pouch_request *pr, const char *server, const char *db, const char *id, const char *newid, const char *revision){
    /*
...
pouch_request *doc_delete(pouch_request *pr, const char *server, const char *db, const char *id, const char *rev){
    /*
...
char *doc_get_cur_rev(pouch_request *pr, const char *server, const char *db, const char *id){
    /*
...
pouch_request *doc_add_attachment(pouch_request *pr, const char *server, const char *db, const char *doc, const char *filename){
    /*
    ...
    pouch_request *pr_add_usrpwd(pouch_request *pr, const char *usrpwd, size_t length){
        if (pr->usrpwd)
            free(pr->usrpwd);
