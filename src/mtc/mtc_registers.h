...
#ifndef _MTC_REGISTERS_H
#define _MTC_REGISTERS_H
...
static const uint32_t mtcRegAddresses[21] = {MTCControlReg,MTCSerialReg,MTCDacCntReg,MTCSoftGTReg,MTCPedWidthReg,MTCCoarseDelayReg,MTCFineDelayReg,MTCThresModReg,MTCPmskReg,MTCScaleReg,MTCBwrAddOutReg,MTCBbaReg,MTCGtLockReg,MTCMaskReg,MTCXilProgReg,MTCGmskReg,MTCOcGtReg,MTCC50_0_31Reg,MTCC50_32_42Reg,MTCC10_0_31Reg,MTCC10_32_52Reg};
static const char mtcRegNames[21][50] = {"Control","Serial","DAC Control","Soft GT","Pedestal Width","Coarse GT Delay","Fine GT Delay","Threshold Monitor","Pedestal Crate Mask","Prescale Value","Next Write Pointer","Memory Access Pointer","Lockout Width","GT Mask","Xilinx Program","GT Crate Mask","GT Count","Lower 50MHz Count","Upper 50MHz Count","Lower 10MHz Count","Upper 10MHz Count"};
